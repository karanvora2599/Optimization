...
def main():
    ...
    for epoch in range(epochs):
        ...
        train_end = time.time()
        print(f"Tensor Train time: {train_end - train_start} seconds") 
        ...
        correct, loss, y_true_cuda, y_pred_cuda = evaluate_tensor(data_loader = test_loader, model=model, criterion=criterion)
        eval_end = time.time()
        print(f"Tensor Eval time: {eval_end - eval_start} seconds")
        ...
        epoch_end = time.time()
        print(f"Tensor Epoch time: {epoch_end - epoch_start} seconds") 
    
    training_end = time.time()
    print(f"Total training time with Tensor: {training_end - training_start} seconds")
